    ...
    <div class="card flat">
      ...
      <div class="card-body">
        ...
        <div class="row" style="padding-top:12px;">
          <div class="col-md-6">
            <a href="barang-add" class="btn btn-success mr-1 mb-1"><i class="fa fa-plus-circle"></i> &nbsp;Tambah</a>
          </div>
          <div class="col-md-2">
...
<input type="hidden" name="hidden_column_name" id="hidden_column_name" value="b.created_at">
