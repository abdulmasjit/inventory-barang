    ...
    <div class="card flat">
      ...
      <div class="card-body">
        ...
        <div class="row" style="padding-top:12px;">
          <div class="col-md-6">
            <a href="{{ url('/barang-keluar/add') }}" class="btn btn-success mr-1 mb-1" id="btn-tambah"><i
...
<input type="hidden" name="hidden_column_name" id="hidden_column_name" value="bk.created_at">
<input type="hidden" name="hidden_sort_type" id="hidden_sort_type" value="desc">
<div id="div_modal"></div>
@endsection
@section('js')
<script src="{{ asset('assets/js/pages/barang-keluar.js') }}"></script>
@endsection
